...
public class MangaDistrict : MadaraBase
{
    public MangaDistrict(IIndexerHttpClient httpClient, IEventAggregator eventAggregator, IIndexerStatusService indexerStatusService, IConfigService configService, Logger logger, IServiceProvider provider)
